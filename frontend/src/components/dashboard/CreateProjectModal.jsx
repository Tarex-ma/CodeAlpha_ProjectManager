  ...
  return (
    <div className={styles.overlay} role="dialog" aria-modal="true" aria-labelledby="modal-title">
      ...
      <div className={styles.modalPanel} style={{ position: 'relative' }}>
        ...
        {/* Header */}
        <div style={{ borderBottom: '1px solid #1e2535', paddingBottom: '1rem', marginBottom: '1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <h2 id="modal-title" style={{ fontSize: '1.375rem', fontWeight: 700, color: '#e6edf3', margin: 0 }}>
            Create New Project
          </h2>
          <button
            onClick={onClose}
            style={{ background: 'transparent', border: 'none', cursor: 'pointer', color: '#4a5568', display: 'flex', padding: '4px' }}
        ...
        <form onSubmit={handleSubmit} noValidate>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.125rem' }}>
            ...
            <div className={styles.fieldGroup}>
              <label htmlFor="proj-name" className={styles.label}>
